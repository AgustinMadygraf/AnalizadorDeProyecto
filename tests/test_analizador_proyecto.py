...
class TestAnalizadorDeProyecto(unittest.TestCase):
    ...
    def test_generar_reporte(self, mock_getsize):
        analizador = AnalizadorDeProyecto('ruta/al/proyecto')
        ...
        self.assertIn("Archivo: ruta/al/proyecto/archivo1.txt - Tamaño: 1024 bytes", reporte)
        self.assertIn("Archivo: ruta/al/proyecto/archivo2.txt - Tamaño: 1024 bytes", reporte)
